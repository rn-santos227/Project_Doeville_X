...
namespace Project::Factories {
  ComponentsFactory::ComponentsFactory(ConfigHandler& configHandler, LogsManager& logsManager)
  : configHandler(configHandler), logsManager(logsManager), renderer(nullptr) {}
